 ...
 *             specified channel.
 */
void c_lqe_ma_open(struct pipe *p, struct stackmodule_i *module);
 ...
 */
void c_lqe_ma_close(struct pipe *p, struct stackmodule_i *module);
 ...
 *
 */
int c_lqe_ma_send(struct pipe *p, struct stackmodule_i *module);
 ...
 */
void c_lqe_ma_recv(struct pipe *p, struct stackmodule_i *module);
 ...
 */
void c_lqe_ma_sent(struct pipe *p, struct stackmodule_i *module);
