...
#ifndef C_LQU_EWMA_H_
#define C_LQU_EWMA_H_
 ...
 *             specified channel.
 */
void c_lqe_ewma_open(struct pipe *p, struct stackmodule_i *module);
 ...
 */
void c_lqe_ewma_close(struct pipe *p, struct stackmodule_i *module);
 ...
 *
 */
int c_lqe_ewma_send(struct pipe *p, struct stackmodule_i *module);
 ...
 */
void c_lqe_ewma_recv(struct pipe *p, struct stackmodule_i *module);
 ...
 */
void c_lqe_ewma_sent(struct pipe *p, struct stackmodule_i *module);
